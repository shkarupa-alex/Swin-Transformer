...
[08/12/2022] Swin Transformers (V1 and V2) port with pretrained weights implemented in Tensorflow (Keras): [TFSwin]([https://github.com/NVIDIA/FasterTransformer/blob/main/docs/swin_guide.md](https://github.com/shkarupa-alex/tfswin))
